                    ...
                    <tbody>
                        <?php foreach ($category as $key => $cate): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url('category/delete/' . $cate->id); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Bạn chắc chắn muốn xóa?');"><i class="fa fa-trash"></i> Xóa</a>
                                    <a href="<?php echo base_url('category/edit/' . $cate->id); ?>" class="btn btn-warning btn-sm"><i class="fa fa-pencil-alt"></i> Sửa</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
